 ...
 */
public class AWTInputDevice implements InputDevice, KeyListener, MouseListener, MouseMotionListener {
	...
	public AWTInputDevice(Java2DRenderer renderer) {
	...
	public Point getPointer() {
		...
		return new Point(pointerOnCanvasX, pointerOnCanvasY);
	}
